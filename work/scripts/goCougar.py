...
wrkdir = '/home/cgpayne/cougwork/imsrg_code/imsrg/work/'
#wrkdir = '/home/cgpayne/'
chdir(wrkdir)
print 'wrkdir    = ',wrkdir
MNU  =  {}
...
#MNU['int'] = 'chi2b' # hw = 8,12,16,20,24,28,32,36,40
#MNU['int'] = 'magic' # hw = 16,24
#MNU['int'] = 'new_magic' # hw = 16
...
if MNU['int'] == 'BARE':
  ...
  print 'running Darmstadt-style int...'
  ...
  print 'running post-cougar-failure (aka: new) Johannes-style int...'
  ARGS['file2e1max'] = '14 file2e2max=28 file2lmax=14'
  ARGS['file3e1max'] = '14 file3e2max=28 file3e3max=16'
  ARGS['e3max'] = '16'
elif MNU['int'] == 'v3trans':
  print 'running new GTquenching-style int...'
  ARGS['file2e1max'] = '14 file2e2max=28 file2lmax=14'
  ARGS['file3e1max'] = '14 file3e2max=28 file3e3max=16'
  ARGS['e3max'] = '16'
else:
...
#for (A,Z) in [(82,34)]: # Se82
  ...
  #for MNU['Decay'] in ['2c']:
    ...
    if MNU['Decay'] == '2':
      ...
      ARGS['Operators'] = 'GamowTeller'
      ARGS['OperatorsFromFile'] = 'GTMEC^1_1_0_2^/itch/exch/GT/MEC_Park2003nl0_HebelerLamreg394_N1max12_N12max24_hbo16.dat.gz'
      ...
      for hw in [10.49]:
        ...
        if MNU['int'] == 'BARE':
          ...
          if MNU['int'] == 'chi2b':
            ...
            ARGS['2bme'] = '/itch/exch/me2j/fromJohannes/vnn_hw%d.00_kvnn10_lambda1.80_mesh_kmax_7.0_100_pc_R15.00_N15.dat_to_me2j.gz'%(hw)
          elif MNU['int'] == 'new_magic':
            ARGS['2bme'] = '/itch/cgpayne/interactions/misc/vnn_hw%d.00_kvnn10_lambda1.80_mesh_kmax_7.0_100_pc_R15.00_N15.dat_to_me2j.gz'%(hw)
          elif MNU['int'] == 'v3trans':
            ARGS['2bme'] = '/itch/cgpayne/interactions/misc/TBMEA2n4lo500-srg2.0_14_28.%d_TUD.int.gz'%(hw)
          if MNU['BB'] == '3N' or MNU['BB'] == 'HF':
            ...
            if MNU['int'] == 'chi2b':
              ...
              #ARGS['3bme'] = '/itch/exch/me3j/chi2b3b400cD-02cE0098_srg0800ho40C_eMax14_EMax14_hwHO0%d.me3j.gz'%(hw) # for Jiangming
              ARGS['LECs'] = 'srg0625'
            elif MNU['int'] == 'magic':
              ARGS['3bme'] = '/itch/exch/me3j/fromJohannes/jsTNF_Nmax_16_J12max_8_hbarOmega_%d.00_Fit_cutoff_2.00_nexp_4_c1_1.00_c3_1.00_c4_1.00_cD_1.00_cE_1.00_2pi_0.00_2pi1pi_0.00_2picont_0.00_rings_0.00_J3max_9_new_E3_14_e_14_ant_EM1.8_2.0.h5_to_me3j.gz'%(hw)
              ARGS['LECs'] = 'EM1.8_2.0'
            elif MNU['int'] == 'new_magic':
